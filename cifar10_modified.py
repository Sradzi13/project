...
landmarks_frame = pd.read_csv(csv_file_name)

n = 65
train_img_names = landmarks_frame.ix[:n, 0]
train_landmarks = landmarks_frame.ix[:n, 1].astype('float')
trainset = {}
for i in range(0, n):
...
test_img_names = landmarks_frame.ix[n:, 0]
test_landmarks = landmarks_frame.ix[n:, 1].astype('float')
                                                                                              ...
                                                                                              loss.backward()
                                                                                                  optimizer.step()
                                                                                                      running_loss += loss.data[0]
                                                                                                          ...
                                                                                                          if i % 10 == 9:    # print every 10 mini-batches
                                                                                                              print('[%d, %5d] loss: %.3f' % (epoch + 1, i + 1, running_loss / 10))    # print statistics
                                                                                                                  running_loss = 0.0
